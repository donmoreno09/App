...
QtObject {
    ...
    readonly property color blackA30: hexWithAlpha(black500, 0.3)
    ...
    readonly property color whiteA2:  hexWithAlpha(white500, 0.02)
    readonly property color whiteA1:  hexWithAlpha(white500, 0.01)
